...
\caption{Um modelo de seleção de pessoal em duas etapas} %\cite{litecky:04}} Precisa citar outra vez na imagem? 
	...
	\centering
		\begin{tabular}{|c|c|c|}
		  \hline
			...
			Extroversão	 	& \vtop{\hbox{\strut Active}
			...
			\\ \hline
			Socialização	&	\vtop{\hbox{\strut Appreciative}
			...
			\\ \hline
			Realização	&	\vtop{\hbox{\strut Efficient}
			...
			\\ \hline
			Neuroticismo	&	\vtop{\hbox{\strut Anxious}
			...
			\\ \hline
			Abertura para experiências	& \vtop{\hbox{\strut Artistic}
														\hbox{\strut Curious}
