...
\begin{titlepage}
 ...
 \begin{center}
  ...
  {\Large \textsc{Programa de Educação Tutorial} } \\ [1.5ex]
  {\Large \textsc{Grupo PET-Tele} } \vfill
  {\Huge Modelo de Monografia para Mestrado} \vfill
...
\begin{titlepage}
  \begin{center}
    \Large{\textsc{Universidade Federal Fluminense} \\
           ...
           \textsc{Mestrado em Engenharia de Telecomunicações} 
          }
    \par\vfill
    \LARGE{Nome do autor}
    \par\vfill
...
Dissertação apresentada ao Curso de Mestrado \linebreak em Engenharia de Telecomunicações da \linebreak Universidade Federal Fluminense, como \linebreak requisito parcial para obtenção do Grau de Mestre. Área de Concentração: Sistemas de Telecomunicações.
